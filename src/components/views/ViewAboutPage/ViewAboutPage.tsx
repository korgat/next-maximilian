  ...
  return (
    <div className="container mx-auto px-4 mt-10 mb-8">
      ...
      <p className="text-gray-800 mb-4">
        ...
        platform that connects people with similar interests and passions. Our mission is to provide
        a space where people can come together, learn, and grow through shared experiences.
      </p>
      <p className="text-gray-800 mb-4">
      ...
      <p className="text-gray-800 mb-4">
        ...
        committed to creating a welcoming and inclusive environment for all members. We believe that
        everyone has something to offer, and that by coming together, we can achieve great things.
      </p>
      <p className="text-gray-800 mb-4">
        ...
        social gatherings, and more. Our events are designed to provide a safe and supportive space
        where you can explore your passions, expand your horizons, and connect with others.
      </p>
      <p className="text-gray-800 mb-4">
        We're always looking for new members to join our community. If you're interested in getting
        involved, please don't hesitate to get in touch. We'd love to hear from you!
      </p>
      <p className="text-gray-800 mb-10">
        Thank you for visiting our website. We hope to see you at one of our meetups soon!
      </p>
      <Button text="Subscribe" fill="true" />
    </div>
  );
};
